      ...
      <SectionLayout>
        <div className="flex items-center flex-wrap gap-4 pb-4">
          ...
          <div className="md:py-4 flex-[1_1_18rem] md:p-4 rounded-xl md:border border-blackgray md:text-lg text-justify">
            <p>
              {
                "I am Abdallah Moubarak, a Lebanese national, deeply rooted in academia with a robust academic background in Biomedical Engineering and a Master's degree in Healthcare Information Technology. My unwavering passion lies in the realm of design and innovation, where I excel in crafting solutions that drive meaningful impact."
              }
            </p>
            <br />
            <p>
